  ...
  <footer class="bg-purple-progress py-20 text-white text-lg">
    <div class="container mx-auto">
      <div class="sm:flex mb-4">
        ...
        <div class="sm:w-1/4 h-auto">
          <div class="mb-8 font-bold">PT Backer Inc.</div>
          <ul class="font-light">
            <li class="mb-3">Pacific Tower B, 33rd Floor</li>
            <li class="mb-3">Jalan Street Kav. 62</li>
            <li class="mb-3">Jakarta, 11410, Indonesia</li>
            <li class="mb-3">+021 2222 3333</li>
